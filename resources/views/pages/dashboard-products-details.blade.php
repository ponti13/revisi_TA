...
>
  <div class="container-fluid">
    <div class="dashboard-heading">
      <h2 class="dashboard-title">Rincian Produk</h2>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select name="status_sedia" id="editor">
                        <option value="1" @if($product->status_sedia) selected @endif>Tersedia</option>
                        <option value="0" @unless($product->status_sedia) selected @endif>Tidak Tersedia</option>
                    </select>
                    </div>
                  </div>
