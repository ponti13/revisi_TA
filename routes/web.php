...
Route::get('/cek-ongkir', [CheckOngkirController::class, 'index'])->name('ongkir.index');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/dashboard', 'DashboardTransactionController@index')
        ->name('dashboard');

        Route::get('/dashboard/transactions', 'DashboardTransactionController@tx')
